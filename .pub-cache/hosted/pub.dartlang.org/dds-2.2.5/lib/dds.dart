...
abstract class DartDevelopmentService {
  ...
  static Future<DartDevelopmentService> startDartDevelopmentService(
    ...
    // print("dds 1 -=-=-=-=-=-=-=-=-=-> rmVmServiceUri ${remoteVmServiceUri}");
    // print("dds 1 -=-=-=-=-=-=-=-=-=-> serviceUri ${serviceUri}");
    ...
    // print("dds 2 -=-=-=-=-=-=-=-=-=-> rmVmServiceUri ${remoteVmServiceUri}");
    // print("dds 2 -=-=-=-=-=-=-=-=-=-> serviceUri ${serviceUri}");
    if (serviceUri != null) {
    ...
    // print("dds 3 -=-=-=-=-=-=-=-=-=-> rmVmServiceUri ${remoteVmServiceUri}");
    // print("dds 3 -=-=-=-=-=-=-=-=-=-> serviceUri ${serviceUri}");
    ...
    // print("dds 4 -=-=-=-=-=-=-=-=-=-> rmVmServiceUri ${remoteVmServiceUri}");
    // print("dds 4 -=-=-=-=-=-=-=-=-=-> serviceUri ${serviceUri}");
    ...
    // print("dds 5 -=-=-=-=-=-=-=-=-=-> rmVmServiceUri ${remoteVmServiceUri}");
    // print("dds 5 -=-=-=-=-=-=-=-=-=-> serviceUri ${serviceUri}");
    await service.startService();
    // print("dds -=-=-=-=-=-=-=-=-=-> service rmVmServiceUri ${service.remoteVmServiceUri}");
    // print("dds -=-=-=-=-=-=-=-=-=-> service Uri ${service.uri}");
    // print("dds -=-=-=-=-=-=-=-=-=-> service remoteVmServiceWsUri ${service.remoteVmServiceWsUri}");
    // print("dds -=-=-=-=-=-=-=-=-=-> service sseUri ${service.sseUri}");
    // print("dds -=-=-=-=-=-=-=-=-=-> service wsUri ${service.wsUri}");
    return service;
  }
