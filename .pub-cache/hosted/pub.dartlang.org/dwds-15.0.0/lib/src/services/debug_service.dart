  ...
  static Future<DebugService> start(
    ...
    if (useSse && !spawnDds) {
      ...
      handler = (shelf.Request request) {
        ...
        // print("root og uri: ${request.requestedUri}"); 
        // print("root canhijack: ${request.canHijack}"); 
        // print("root handle path: ${request.handlerPath}"); 
        // print("root final uri ? : ${request.url}"); 
